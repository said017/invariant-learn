...
contract Echidna_RewardManager {
    ...
    function echidna_rewards_match_added() public view returns (bool) {
        uint256 epoch = manager.currentEpoch();
    ...
    function echidna_shares_sum_lte_supply() public view returns (bool) {
        uint256 epoch = manager.currentEpoch();
    ...
    function echidna_points_sum_lte_total() public view returns (bool) {
        uint256 epoch = manager.currentEpoch();
    ...
    function echidna_epoch_always_gte_1() public view returns (bool) {
